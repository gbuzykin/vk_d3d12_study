...
IMPLEMENT_VK_DESTROYER_WITH_PARENT(Device, ShaderModule);
IMPLEMENT_VK_DESTROYER_WITH_PARENT(Device, PipelineLayout);
IMPLEMENT_VK_DESTROYER_WITH_PARENT(Device, Pipeline);
IMPLEMENT_VK_DESTROYER_WITH_PARENT(Device, Buffer);
