...
Surface::~Surface() {
    instance_.get().removeSurface(this);
    ObjectDestroyer<VkSurfaceKHR>::destroy(~instance_.get(), surface_);
}
...
bool Surface::create(const WindowDescriptor& win_desc) {
    ...
    switch (win_desc.platform) {
        ...
        case PlatformType::PLATFORM_WIN32: {
            ...
            result = vkCreateWin32SurfaceKHR(~instance_.get(), &create_info, nullptr, &surface_);
        } break;
#endif
        ...
        case PlatformType::PLATFORM_XLIB: {
            ...
            result = vkCreateXlibSurfaceKHR(~instance_.get(), &create_info, nullptr, &surface_);
        } break;
#endif
        ...
        case PlatformType::PLATFORM_XCB: {
            ...
            result = vkCreateXcbSurfaceKHR(~instance_.get(), &create_info, nullptr, &surface_);
        } break;
#endif
        ...
        case PlatformType::PLATFORM_WAYLAND: {
            ...
            result = vkCreateWaylandSurfaceKHR(~instance_.get(), &create_info, nullptr, &surface_);
        } break;
#endif
        default: {
...
util::ref_ptr<ISwapChain> Surface::createSwapChain(IDevice& device, const uxs::db::value& opts) {
    util::ref_ptr swap_chain = ::new SwapChain(static_cast<Device&>(device), *this);
