...
DEVICE_LEVEL_VK_FUNCTION_FROM_EXTENSION(vkCmdSetPrimitiveTopologyEXT, VK_EXT_EXTENDED_DYNAMIC_STATE_EXTENSION_NAME);
DEVICE_LEVEL_VK_FUNCTION_FROM_EXTENSION(vkCmdBindVertexBuffers2EXT, VK_EXT_EXTENDED_DYNAMIC_STATE_EXTENSION_NAME);
