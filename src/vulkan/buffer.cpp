...
ResultCode Buffer::updateBuffer(std::size_t size, const void* data, std::size_t offset) {
    if (!device_.writeToDeviceLocalMemory(VkDeviceSize(size), data, buffer_, VkDeviceSize(offset), 0,
